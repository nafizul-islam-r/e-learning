...
<body>
   ...
   <div class="side-bar">
      ...
      <nav class="navbar">
         <a href="home.php" class="primary-btn-1 my-2 my-sm-0"><i class="fa fa-home mr-3"
               aria-hidden="true"></i><span>Home</span></a>
         <a href="about.php" class="primary-btn-1 my-2 my-sm-0 ml-3"><i class="fa fa-question mr-3"
